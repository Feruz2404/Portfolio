      ...
      >
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
          <input
            ...
            className="px-6 py-3 rounded-full bg-white/5 border border-white/10 text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-indigo-500 w-72"
          />
