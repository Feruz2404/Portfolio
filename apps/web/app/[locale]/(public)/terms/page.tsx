...
export async function generateMetadata({ params }: { params: Promise<{ locale: Locale }> }): Promise<Metadata> {
  ...
  return buildMetadata({ locale, path: "/terms", title: t("termsTitle"), description: t("termsTitle") });
}
  ...
  return (
    <Section width="content" className="pt-16 md:pt-24">
      <div className="max-w-prose">
        <Eyebrow>{t("termsTitle")}</Eyebrow>
        <h1 className="mt-5 text-4xl font-semibold tracking-tight text-bone md:text-5xl">{t("termsTitle")}</h1>
